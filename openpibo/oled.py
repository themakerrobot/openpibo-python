...
from .modules.oled import st7735, ssd1306, board, busio, digitalio
...
class OledRGB:
  """
Functions:
:meth:`~openpibo.oled.OledRGB.show`
:meth:`~openpibo.oled.OledRGB.clear`
:meth:`~openpibo.oled.OledRGB.set_font`
:meth:`~openpibo.oled.OledRGB.draw_text`
:meth:`~openpibo.oled.OledRGB.draw_image`
:meth:`~openpibo.oled.OledRGB.draw_data`
...
:meth:`~openpibo.oled.OledRGB.draw_line`
  ...
  * 도형 그리기
  ...
  def __init__(self, w=128, h=64):
    ...
    spi = busio.SPI(11,10,9)
    self.oled = st7735.ST7735S(spi, rotation=270, width=self.height, height=self.width, cs=cs_pin, bl=cs_pin, dc=dc_pin, rst=reset_pin,  x_offset=1, y_offset=1)
    self.font = ImageFont.truetype(self.font_path, self.font_size)
